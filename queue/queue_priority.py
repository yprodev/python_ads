...
class PriorityQueue:
	...
	# Removes and returns the firs item in the queue
	def dequeue(self):
		assert not self.isEmpty(), "Cannot dequeue from an empty queue"

		# Find the entry with the highest priority
		highest = self._qList[i].priority # ??? Come on! It's not right to place it here
		# There should be outter loop or we need to place it somewhere below
