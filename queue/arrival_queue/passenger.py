...
class Passenger:
	...
	# Gets the paasenger's id number
	def idNum(self):
		return self._idNum

	# Get the passenger's arrival time
	def timeArrived(self):
		return self._arrivalTime

# Used to store and maange information related to an airline ticket agent
class TicketAgent:
	...
	# Indicates the ticket agent has begun assisting the passenger
